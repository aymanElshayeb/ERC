...
public class DownloadActivity extends BaseActivity {
    ...
    private UploadActivity localBackup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localBackup = new UploadActivity(DownloadActivity.this);
    ...
    public void onExport(String path) {
        ...
        sqliteToExcel.exportAllTables(fileName, new SQLiteToExcel.ExportListener() {
            ...
            public void onStart() {
                ...
                loading = new ProgressDialog(DownloadActivity.this);
            ...
            public void onCompleted(String filePath) {
                ...
                mHand.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        loading.dismiss();
                        Toasty.success(DownloadActivity.this, R.string.data_successfully_exported, Toast.LENGTH_SHORT).show();
            ...
            public void onError(Exception e) {
                ...
                loading.dismiss();
                Toasty.error(DownloadActivity.this, R.string.data_export_fail, Toast.LENGTH_SHORT).show();
            }
        });
    }
